...
?>
    ...
    <body>
        <button class="waves-effect waves-light  btn logout red lighten-1" onclick="window.location.href+='?logout=1';"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span></button>
        <div id="loadingDiv" class="col-md-12 animated">
            <div class="row">
                <span id="legendLoading">Criando Gráficos</span>
                <img alt="Carregando Gráficos" src="img/graph-loading.gif">
            </div>
        </div>
        <div id="loadingDiv2" class="col-md-12 animated">
            <div class="row">
                <span id="legendLoading2">Pesquisando Registros</span>
                <img alt="Pesquisando Registros" src="img/time-loading.gif" width="70%">
            </div>
        </div>
        <div class="container-fluid">
            <header class="col-md-12">
                <div class="row">
                    <a href="graficos.php"><button class="waves-effect waves-light btn-large red accent-2 btnTop" onclick="startLoadingGraphs()">Relatório</button></a>
                    <div class="splitter"></div>
                    <a href="relatorio.php?p=1"><button class="waves-effect waves-light btn-large cyan darken-1 btnTop" onclick="startLoadingRegistro()">Registros</button></a>
                </div>
            ...
            <div class="main">
                <form method="post" action="cadastrar.php">
                    <div class="row">
                        <div class="input-field col s5 nplf">
                            <i class="material-icons prefix setColor">account_circle</i>
                            <input id="nome" name="nome" autocomplete="off" type="text" class="validate" required>
                            <label for="nome">Nome</label>
                        </div>
                        <div class="input-field col offset-s2 s5 nplf">
                    ...
                    <div class="row">
                        <div class="input-field col s5 nplf">
                            ...
                            <input id="telefone" autocomplete="off" name="telefone" type="text" class="validate" onkeydown="MaskDown(this)" onkeyup="MaskUp(this,event,'(##) #####-####')">
                    ...
                    <div class="row">
                        <div class="input-field col s5 nplf">
                            ...
                            <input type="radio" required class="filled-in" id="divulga1" value="1" name="divulga" />
                            <label class="divulgaLbl" for="divulga1">Internet</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga2" value="2" name="divulga" />
                            <label class="divulgaLbl" for="divulga2">Panfleto</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga3" value="3" name="divulga" />
                            <label class="divulgaLbl" for="divulga3">TV</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga4" value="4" name="divulga" />
                            <label class="divulgaLbl" for="divulga4">Rádio</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga5" value="5" name="divulga" />
                            <label class="divulgaLbl" for="divulga5">Amigo</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga6" value="6" name="divulga" />
                            <label class="divulgaLbl" for="divulga6">Visitou a UFV-Florestal</label> <span class="ball"></span>
                            <input type="radio" required class="filled-in" id="divulga7" value="7" name="divulga" />
                            <label class="divulgaLbl" for="divulga7">Outras</label>
                        </div>
                        <div class="switch offset-s2 col s5" style="margin-top: 15px">
                            <label for="isEstudante" class="lblSwitch">Você é estudante?</label><br>
                            <label>
                        Não
                        <input id="isEstudante" name="isEstudante" value="1" type="checkbox" checked onchange="isStudent(this)">
                        <span class="lever"></span>
                        Sim
                        </label>
                        </div>
                    </div>
                    <div class="row noStudent disappear" style="margin-top: 60px">
                        <div class="switch">
                            <label for="interesse" class="lblSwitch">Você tem interesse em estudar na UFV?</label><br>
                            <label>
                        Não
                        <input id="interesse" name="interesse" type="checkbox" onchange="interesseUFV(this)">
                        <span class="lever"></span>
                        Sim
                        </label>
                        </div>
                    </div>
                    <div class="row motivoVisita disappear">
                        <div class="input-field col s6 nplf">
                            <textarea id="motivoVisita" name="motivoVisita" class="materialize-textarea"></textarea>
                    ...
                    <div class="row isStudent">
                        ...
                        <div class="input-field col offset-s2 s5 npl isStudentf">
                    ...
                    <div class="row cursoInteresse">
                        <div class="input-field col s5 nplf">
                            ...
                            <select id="curso1" name="curso1" style="display: block">
                                ...
                                <optgroup label="Cursos Oferecidos pela UFV">
                                    <option value="2">Administração</option>
                                    <option value="3">Agronomia</option>
                                    <option value="4">Ciência da Computação</option>
                                    <option value="5">Engenharia de Alimentos</option>
                                    <option value="6">Licenciatura em Ciências Biológicas</option>
                                    <option value="7">Licenciatura em Educação Física</option>
                                    <option value="8">Licenciatura em Física</option>
                                    <option value="9">Licenciatura em Matemática</option>
                                    <option value="10">Licenciatura em Química</option>
                                    <option value="11">Tecnologia em Gestão Ambiental</option>
                                </optgroup>
                                <optgroup label="Cursos Técnicos">
                                    <option value="12">Técnico em Alimentos</option>
                                    <option value="13">Técnico em Agropecuária</option>
                                    <option value="14">Técnico em Eletrônica</option>
                                    <option value="15">Técnico em Eletrotécnica</option>
                                    <option value="16">Técnico em Hospedagem</option>
                                    <option value="17">Técnico em Informática</option>
                                </optgroup>
                                <optgroup label="Cursos Superiores em Geral">
                                    <option value='19'>Biologia marinha</option>
                                    <option value='20'>Biomedicina</option>
                                    <option value='21'>Botânica</option>
                                    <option value='22'>Ciências Agrárias (licenciatura)</option>
                                    <option value='23'>Ciências Ambientais</option>
                                    <option value='24'>Ciências da Saúde</option>
                                    <option value='25'>Ciências do Meio Aquático</option>
                                    <option value='26'>Ecologia</option>
                                    <option value='27'>Enfermagem</option>
                                    <option value='28'>Fisioterapia</option>
                                    <option value='29'>Fonoaudiologia</option>
                                    <option value='30'>Gerontologia</option>
                                    <option value='31'>Medicina</option>
                                    <option value='32'>Medicina veterinária</option>
                                    <option value='33'>Meteorologia</option>
                                    <option value='34'>Microbiologia e Imunologia</option>
                                    <option value='35'>Naturologia</option>
                                    <option value='36'>Neurociência</option>
                                    <option value='37'>Nutrição</option>
                                    <option value='38'>Obstetrícia</option>
                                    <option value='39'>Odontologia</option>
                                    <option value='40'>Quiropraxia</option>
                                    <option value='41'>Saúde Coletiva</option>
                                    <option value='42'>Terapia ocupacional</option>
                                    <option value='43'>Zootecnia</option>
                                    <option value='44'>Aquacultura</option>
                                    <option value='45'>Cafeicultura</option>
                                    <option value='46'>Biotecnologia</option>
                                    <option value='47'>Ciência dos Alimentos</option>
                                    <option value='48'>Cosmetologia</option>
                                    <option value='49'>Drenagem e Irrigação</option>
                                    <option value='50'>Enologia</option>
                                    <option value='51'>Fruticultura</option>
                                    <option value='52'>Gestão de Recursos Hídricos</option>
                                    <option value='53'>Horticultura</option>
                                    <option value='54'>Meliponicultura</option>
                                    <option value='55'>Oftálmica</option>
                                    <option value='56'>Radiologia</option>
                                    <option value='57'>Silvicultura</option>
                                    <option value='58'>Sistemas Biomédicos</option>
                                    <option value='59'>Engenharia agronômica</option>
                                    <option value='60'>Astronomia</option>
                                    <option value='61'>Bioengenharia</option>
                                    <option value='62'>Biofísica</option>
                                    <option value='63'>Ciências Contábeis</option>
                                    <option value='64'>Ciências Biomoleculares</option>
                                    <option value='65'>Ciências Matemáticas da Terra</option>
                                    <option value='66'>Ciências Naturais (licenciatura)</option>
                                    <option value='67'>Ciência & Tecnologia</option>
                                    <option value='68'>Educação do Campo (licenciatura)</option>
                                    <option value='69'>Engenharia aeroespacial</option>
                                    <option value='70'>Engenharia aeronáutica</option>
                                    <option value='71'>Engenharia Agrícola</option>
                                    <option value='72'>Engenharia de Alimentos</option>
                                    <option value='73'>Engenharia Ambiental</option>
                                    <option value='74'>Engenharia biomédica</option>
                                    <option value='75'>Engenharia Cartográfica (ou Engenharia geográfica)</option>
                                    <option value='76'>Engenharia Civil</option>
                                    <option value='77'>Engenharia de Computação</option>
                                    <option value='78'>Engenharia de controle e automação</option>
                                    <option value='79'>Engenharia Elétrica (ou Engenharia de Energia)</option>
                                    <option value='80'>Engenharia Física</option>
                                    <option value='81'>Engenharia Florestal</option>
                                    <option value='82'>Engenharia geológica</option>
                                    <option value='83'>Engenharia Industrial Madeireira</option>
                                    <option value='84'>Engenharia de manufatura</option>
                                    <option value='85'>Engenharia de Materiais</option>
                                    <option value='86'>Engenharia Mecânica</option>
                                    <option value='87'>Engenharia Mecatrônica</option>
                                    <option value='88'>Engenharia Metalúrgica</option>
                                    <option value='89'>Engenharia Militar</option>
                                    <option value='90'>Engenharia de Minas</option>
                                    <option value='91'>Engenharia Naval e Oceânica</option>
                                    <option value='92'>Engenharia Nuclear</option>
                                    <option value='93'>Engenharia de Pesca</option>
                                    <option value='94'>Engenharia de Petróleo</option>
                                    <option value='95'>Engenharia de Produção</option>
                                    <option value='96'>Engenharia Química</option>
                                    <option value='97'>Engenharia Sanitária</option>
                                    <option value='98'>Engenharia de Sistemas Eletrônicos</option>
                                    <option value='99'>Engenharia de Software</option>
                                    <option value='100'>Engenharia de Tecidos</option>
                                    <option value='101'>Engenharia de Telecomunicações</option>
                                    <option value='102'>Engenharia Têxtil</option>
                                    <option value='103'>Estatística</option>
                                    <option value='104'>Farmácia (ou Bioquímica)</option>
                                    <option value='105'>Física computacional</option>
                                    <option value='106'>Física médica</option>
                                    <option value='107'>Geofísica</option>
                                    <option value='108'>Geologia (licenciatura)</option>
                                    <option value='109'>Geoprocessamento e Sensoriamento Remoto</option>
                                    <option value='110'>Informática (licenciatura)</option>
                                    <option value='111'>Informática biomédica</option>
                                    <option value='112'>Matemática Aplicada</option>
                                    <option value='113'>Matemática computacional</option>
                                    <option value='114'>Nanotecnologia</option>
                                    <option value='115'>Oceanografia (arcaicamente referido como Ciência dos Mares)</option>
                                    <option value='116'>Química ambiental</option>
                                    <option value='117'>Química industrial</option>
                                    <option value='118'>Sistemas de Informação</option>
                                    <option value='119'>Agrimensura</option>
                                    <option value='120'>Agroindústria</option>
                                    <option value='121'>Análise e Desenvolvimento de Sistemas</option>
                                    <option value='122'>Automação Industrial</option>
                                    <option value='123'>Biocombustíveis</option>
                                    <option value='124'>Ciências Aeronáuticas</option>
                                    <option value='125'>Ciência dos materiais</option>
                                    <option value='126'>Ciências Náuticas</option>
                                    <option value='127'>Construção de Edifícios</option>
                                    <option value='128'>Construção de Estradas</option>
                                    <option value='129'>Construção Naval</option>
                                    <option value='130'>Energias Renováveis</option>
                                    <option value='131'>Gestão da Tecnologia da Informação</option>
                                    <option value='132'>Gestão de Petróleo e Gás</option>
                                    <option value='133'>Gestão Portuária</option>
                                    <option value='134'>Manutenção Industrial</option>
                                    <option value='135'>Mecatrônica e Mecânica de Precisão</option>
                                    <option value='136'>Mineração</option>
                                    <option value='137'>Processos Metalúrgicos</option>
                                    <option value='138'>Processamento de Dados</option>
                                    <option value='139'>Produção de Laticínios</option>
                                    <option value='140'>Produção de Materiais Plásticos</option>
                                    <option value='141'>Produção Têxtil</option>
                                    <option value='142'>Produção Sucroalcooeira</option>
                                    <option value='143'>Redes de Computadores</option>
                                    <option value='144'>Redes de Telecomunicações</option>
                                    <option value='145'>Saneamento Ambiental</option>
                                    <option value='146'>Segurança da Informação</option>
                                    <option value='147'>Sistemas Biomédicos</option>
                                    <option value='148'>Sistemas Elétricos</option>
                                    <option value='149'>Sistemas Embarcados</option>
                                    <option value='150'>Sistemas de Navegação Fluvial</option>
                                    <option value='151'>Sistemas para Internet</option>
                                    <option value='152'>Telemática</option>
                                    <option value='153'>Administração</option>
                                    <option value='154'>Antropologia</option>
                                    <option value='155'>Arqueologia</option>
                                    <option value='156'>Arquitetura</option>
                                    <option value='157'>Arquivística</option>
                                    <option value='158'>Artes Cênicas</option>
                                    <option value='159'>Artes Visuais</option>
                                    <option value='160'>Biblioteconomia</option>
                                    <option value='161'>Ciências Atuariais</option>
                                    <option value='162'>Ciências Humanas (licenciatura)</option>
                                    <option value='163'>Ciência Política (ou Ciências do Estado)</option>
                                    <option value='164'>Ciências Sociais Licenciatura</option>
                                    <option value='165'>Cinema</option>
                                    <option value='166'>Comunicação social</option>
                                    <option value='167'>Dança (licenciatura)</option>
                                    <option value='168'>Defesa e Gestão Estratégica Internacional</option>
                                    <option value='169'>Desenho Industrial</option>
                                    <option value='170'>Design de Interiores</option>
                                    <option value='171'>Design de Moda</option>
                                    <option value='172'>Direito</option>
                                    <option value='173'>Economia</option>
                                    <option value='174'>Economia Doméstica</option>
                                    <option value='175'>Editoração</option>
                                    <option value='176'>Educação Artística (licenciatura)</option>
                                    <option value='177'>Escultura</option>
                                    <option value='178'>Filosofia (licenciatura)</option>
                                    <option value='179'>Gastronomia</option>
                                    <option value='180'>Geografia (licenciatura)</option>
                                    <option value='181'>Gestão Pública</option>
                                    <option value='182'>Gravurismo</option>
                                    <option value='183'>História (licenciatura)</option>
                                    <option value='184'>História da Arte</option>
                                    <option value='185'>Hotelaria</option>
                                    <option value='186'>Jornalismo</option>
                                    <option value='187'>Letras (licenciatura)</option>
                                    <option value='188'>Linguística</option>
                                    <option value='189'>Museologia</option>
                                    <option value='190'>Música (licenciatura)</option>
                                    <option value='191'>Ordenamento do Território</option>
                                    <option value='192'>Paisagismo</option>
                                    <option value='193'>Pedagogia (licenciatura)</option>
                                    <option value='194'>Pintura</option>
                                    <option value='195'>Psicologia</option>
                                    <option value='196'>Publicidade & Propaganda</option>
                                    <option value='197'>Produção Audiovisual (popularmente referido como Rádio & TV, e mais arcaicamente como Radialismo)</option>
                                    <option value='198'>Produção Cultural</option>
                                    <option value='199'>Relações Internacionais</option>
                                    <option value='200'>Relações Públicas</option>
                                    <option value='201'>Segurança Pública</option>
                                    <option value='202'>Serviço Social</option>
                                    <option value='203'>Sociologia (licenciatura)</option>
                                    <option value='204'>Teatro (licenciatura)</option>
                                    <option value='205'>Teologia</option>
                                    <option value='206'>Transporte Terrestre</option>
                                    <option value='207'>Turismologia</option>
                                    <option value='208'>Urbanismo</option>
                                    <option value='209'>Agroecologia</option>
                                    <option value='210'>Comércio Exterior</option>
                                    <option value='211'>Cooperativismo</option>
                                    <option value='212'>Design de Jogos Digitais</option>
                                    <option value='213'>Design de produto</option>
                                    <option value='214'>Design gráfico</option>
                                    <option value='215'>Eventos</option>
                                    <option value='216'>Esporte e Lazer</option>
                                    <option value='217'>Fotografia</option>
                                    <option value='218'>Gestão do Agronegócio</option>
                                    <option value='219'>Gestão Comercial</option>
                                    <option value='220'>Gestão Financeira</option>
                                    <option value='221'>Gestão Hospitalar</option>
                                    <option value='222'>Gestão de Segurança Privada</option>
                                    <option value='223'>Gestão da Qualidade</option>
                                    <option value='224'>Logística</option>
                                    <option value='225'>Mercadologia</option>
                                    <option value='226'>Negócios Imobiliários</option>
                                    <option value='227'>Processos Escolares</option>
                                    <option value='228'>Produção de Aguardente</option>
                                    <option value='229'>Produção Fonográfica</option>
                                    <option value='230'>Recursos Humanos</option>
                                    <option value='231'>Secretariado</option>
                                    <option value='232'>Segurança no Trabalho</option>
                                    <option value='233'>Transporte Aéreo</option>
                                </optgroup>
                            </select>
                        </div>
                        <div class="input-field col offset-s2 s5 nplf">
                    ...
                    <div class="row">
                        <div class="col s12" style="text-align: center">
                            <button class="waves-effect waves-light btn-large red accent-2" type="submit" onclick="validaRadio()">Cadastrar</button>
                        </div>
                    </div>
                </form>
            </div>
